...
if __name__=='__main__':
    ...
    if args.format == 'text':
        ...
        response_object["power"]["value"] = round(response_object["power"]["value"], 4)
        response_object["psu_voltage"]["value"] = round(response_object["psu_voltage"]["value"], 5)
        response_object["load_voltage"]["value"] = round(response_object["load_voltage"]["value"], 5)
        response_object["current"]["value"] = round(response_object["current"]["value"], 5)
